...
This document outlines how to propose a change to rsi.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("Permian-Global-Research/rsi", fork = TRUE)`.
...
Please note that the rsi project is released with a [Contributor Code of
Conduct](https://docs.ropensci.org/rsi/CODE_OF_CONDUCT.md). By
